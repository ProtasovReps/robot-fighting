...
namespace CharacterSystem.Parameters
{
    public class BotParameters : FighterParameters
    {
        ...
        [field: SerializeField, Min(1f)] public float BaseDamage { get; private set; }
        [field: SerializeField, Min(1f)] public float BaseImpulse { get; private set; }
        [field: SerializeField, Min(1f)] public float AttackInputDelay { get; private set; }
