...
namespace CharacterSystem.Parameters
{
    public class BotParameters : FighterParameters
    {
        ...
        [field: SerializeField] [field: Min(0f)] public float BaseDamage { get; private set; }
        [field: SerializeField] [field: Min(0f)] public float AttackInputDelay { get; private set; }
        [field: SerializeField] [field: Min(0f)] public float BaseImpulse { get; private set; }
